...
///
/// Built on 2025-02-10 at 15:00 UTC
...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	String get choose_company => 'Choose company';
	String get search_by_error_code => 'Search by error code';
	String get home_screen => 'Home screen';
	String get contact_us => 'Contact us';
	String get new_update_title => 'There is a new update!';
	String get new_update_description => 'Do you want to update now?';
...
class _StringsHe implements Translations {
	...
	// Translations
	@override String get welcome => 'ברוך הבא';
	@override String get choose_product => 'בחר מוצר';
	@override String get choose_company => 'בחר חברה';
	@override String get search_by_error_code => 'חיפוש לפי שורת קוד';
	@override String get home_screen => 'דף הבית';
	@override String get contact_us => 'יצירת קשר';
	@override String get new_update_title => 'קיים עדכון חדש!';
	@override String get new_update_description => 'לעדכן עכשיו?';
...
extension on _StringsHe {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'choose_product': return 'בחר מוצר';
